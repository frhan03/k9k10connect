...
class EditStatusStaffPage extends StatefulWidget {
  ...
  const EditStatusStaffPage({
    required this.report,
    required this.displayName,
  });

  @override
  _EditStatusStaffPageState createState() => _EditStatusStaffPageState();
}

class _EditStatusStaffPageState extends State<EditStatusStaffPage> {
